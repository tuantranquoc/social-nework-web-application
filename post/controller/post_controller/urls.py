...
urlpatterns = [
    ...
    path('count/<str:community_type>',
         post_api.get_count_by_community),
    ...
    path('vote/count/user/<str:username>',
         post_api.get_count_by_user_vote),
    ...
    path('comment/<str:username>',
         post_api.get_post_by_username_comment),
    path('up_vote', post_api.find_post_by_up_vote),
    path('up_vote/<str:username>',
         post_api.find_post_by_username_up_vote),
